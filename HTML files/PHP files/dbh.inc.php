...
$sql = "CREATE TABLE IF NOT EXISTS `doctors`(`did` int AUTO_INCREMENT NOT NULL,`fname` varchar(50) NOT NULL,`lname` varchar(50) NOT NULL,`demail` varchar(50) NOT NULL,`pass` varchar(50) NOT NULL,`city` varchar(50) NOT NULL,`zip` int(5) NOT NULL,PRIMARY KEY (`did`));";
if(mysqli_query($conn, $sql))
{
}
else
...
$sql = "CREATE TABLE IF NOT EXISTS `office`(`oid` int AUTO_INCREMENT NOT NULL,`oname` varchar(50) NOT NULL,`oemail` varchar(50) NOT NULL, `pass` varchar(50) NOT NULL,`field` varchar(50) NOT NULL,`city` varchar(50) NOT NULL,`zip` int(5) NOT NULL,PRIMARY KEY (`oid`));";
if(mysqli_query($conn, $sql))
{
}
else
